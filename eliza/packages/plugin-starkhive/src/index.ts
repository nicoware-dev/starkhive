...
export const starkhivePlugin: Plugin = {
    name: "starkhive",
    description: "StarkHive Plugin for Eliza - Starknet DeFi Agent Swarm",
    actions: [transfer, executeSwap, deployToken, transferSubdomain],
    evaluators: [],
    providers: [walletProvider, coinGeckoProvider, defiLlamaProvider],
};

export default starkhivePlugin;
