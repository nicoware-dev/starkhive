            ...
            <main className="flex-1">
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <div className="space-y-8">
                                <h1 className="text-4xl sm:text-5xl md:text-6xl font-black title-gradient" style={{ lineHeight: '1.2' }}>
                                    Revolutionizing DeFi with AI-Powered Agent Swarms on Starknet
                                </h1>
                                <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
                                    Simplify your DeFi experience with the power of Multi-Agent Systems (MAS) on Starknet
                                </p>
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                    ...
                                    <Button
                                        size="lg"
                                        variant="outline"
                                        onClick={() => handleExternalLink('https://github.com/nicoware-dev/starkhive')}
                        ...
                        <div className="flex flex-col items-center space-y-8">
                            <div className="w-full max-w-5xl bg-background rounded-lg p-8 border border-white/[0.08]">
                                <img
                                    ...
                                    alt="StarkHive Architecture Diagram"
                ...
                <section className="py-24 space-y-12">
                    <div className="container text-center space-y-4">
                        ...
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            Seamlessly connected with the leading platforms and protocols in the Starknet ecosystem
                        </p>
                    </div>
                    <LogoCarousel />
                </section>
                ...
                <section id="pricing" className="container py-24 space-y-12">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            StarkHive is and will always be open source! We strongly encourage users to self-host their own instance.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                href: "https://github.com/nicoware-dev/starkhive",
                                featured: true
                            },
                            {
                                title: "Free Tier",
                ...
                <section id="opensource" className="relative py-24">
                    ...
                    <div className="container relative space-y-12">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                                StarkHive is an open-source initiative. We invite developers and contributors to help us expand the MAS ecosystem and redefine DeFi automation together.
                            </p>
                        </div>
                ...
                <section className="container py-24 space-y-12">
                    ...
                    <div className="flex justify-center gap-8">
                        <a href="https://x.com/StarkHiveAgent" target="_blank" rel="noopener noreferrer" className="group">
            ...
            <footer className="border-t border-white/[0.08] bg-background">
                <div className="container py-12">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
                        <div className="space-y-4">
                            <div className="flex flex-col items-center text-center">
                                <div className="flex items-center gap-2">
                                    <img src={logo} alt="StarkHive Logo" className="h-6 w-6" />
                                    <h3 className="text-lg font-semibold gradient-text">StarkHive</h3>
                                </div>
                        ...
                        <div>
                            ...
                            <div className="flex flex-col items-center gap-4 mt-4">
                                <a
                                    href="https://t.me/StarkHiveSalesAgent_bot"
                    ...
                    <div className="mt-12 pt-8 border-t border-white/[0.08] text-center text-sm text-muted-foreground">
                        © 2024 StarkHive. All rights reserved.
                    </div>
                </div>
            </footer>
        </div>
